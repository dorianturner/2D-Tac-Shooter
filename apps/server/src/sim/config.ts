...
export const MAX_READABILITY_EVENTS = 120;
export const READABILITY_EVENT_TTL_TICKS = 6 * TICK_RATE;
export const MAX_DAMAGE_INDICATORS = 120;
export const DAMAGE_INDICATOR_TTL_TICKS = Math.round(1.35 * TICK_RATE);
export const NORMAL_VISION_RAYS = 72;
export const DEBUG_VISION_RAYS = 72;
...
export const BOT_REACTION_MIN_TICKS = Math.round(TICK_RATE * 0.3);
export const BOT_REACTION_MAX_TICKS = Math.round(TICK_RATE * 0.48);
...
export const BOT_STALE_AIM_ERROR = (8 * Math.PI) / 180;
